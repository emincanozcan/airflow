...
DLF_SENSOR_STRING = "airflow.providers.huawei.cloud.sensors.dlf.{}"
...
class TestDLFShowJobStatusSensor(unittest.TestCase):
    def setUp(self):
        self.job_status_sensor = DLFShowJobStatusSensor(
    ...
    @mock.patch(DLF_SENSOR_STRING.format("DLFHook"))
    ...
    @mock.patch(DLF_SENSOR_STRING.format("DLFShowJobStatusSensor.get_hook"), new_callable=PropertyMock)
