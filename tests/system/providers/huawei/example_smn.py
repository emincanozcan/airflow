...
from airflow.providers.huawei.cloud.operators.smn import SMNPublishTextMessageOperator, SMNPublishJsonMessageOperator, SMNPublishMessageTemplateOperator


with DAG('smn', description='Huawei Cloud SMN',
         schedule_interval="@once",
         start_date=datetime(2022, 10, 29), catchup=False) as dag:
